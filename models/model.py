...
class Model(object):
  ...
  @abc.abstractmethod
  def build_inference(self, examples, **kwargs):

    """Builds tensorflow graph for inference.

    Args:
      examples: a python dict mapping from name to input tensors.

    Returns:
      predictions: a dict mapping from name to output tensor.
