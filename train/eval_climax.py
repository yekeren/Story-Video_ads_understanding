...
def evaluate_once(sess, writer, global_step, video_ids, predictions):
  ...
  (precision_at_1, precision_at_3, precision_at_5, precision_at_10, diff_ratio
   ) = eval_utils.evaluate_climax_accuracy(results)

  summary.value.add(tag='metrics/precision_at_1', simple_value=precision_at_1)
  summary.value.add(tag='metrics/precision_at_3', simple_value=precision_at_3)
  summary.value.add(tag='metrics/precision_at_5', simple_value=precision_at_5)
  summary.value.add(tag='metrics/precision_at_10', simple_value=precision_at_10)
  summary.value.add(tag='metrics/diff_ratio', simple_value=diff_ratio)

  logging.info('precision@1=%.4lf', precision_at_1)
  logging.info('precision@3=%.4lf', precision_at_3)
  logging.info('precision@5=%.4lf', precision_at_5)
  logging.info('precision@10=%.4lf', precision_at_10)
  logging.info('diff_ratio=%.4lf', diff_ratio)
